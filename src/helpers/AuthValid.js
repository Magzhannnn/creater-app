...
export const authValid = (email, password, name = "a") => {
  if (name === "") {
...
export const isThereSuch = (users, email) => {
  if (users === null) {
    return false;
  }
...
export const loginIsValidFunc = (users, data) => {
  if (!(users === null)) {
...
export const loginEnter = (users, email, password) => {
